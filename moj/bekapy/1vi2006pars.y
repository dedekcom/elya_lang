...
FOREXPR:	KW_FOR EQFOR1 CMPFOR EQFOR2 METHODBODY	{ ddput3("\tjmp ", poploop(), "\n");
								ddput2( poploop(), ":\n"); poploop();	}
;
...
IFEXPR:	STARTIF1 		{ ifpart3(); }
	|	STARTIF1 KW_ELSE METHODBODY	{ ifpart3(); }
	|	STARTIF1 KW_ELSE IFEXPR		{ ifpart3(); }
;

IFBODY1:	'(' COMPARISON ')'		{ ifpart1(); }
;

IFBODY:  IFBODY1 METHODBODY	{ ifpart2(); }
;
